...
let tepmCountPrimary = 0;
let tepmCountIntermidiate = 0;
let dataRecreation = [];
dataRecreation.primarySchooling = {};
dataRecreation.intermidiateSchooling = {};
for (i = 0; i < timelineMyEducation.educationalSpecification.length; i++) {
    if (timelineMyEducation.educationalSpecification[i].educationType == "01") {
        tepmCountPrimary++;
    ...
    if (timelineMyEducation.educationalSpecification[i].educationType == "02") {
        tepmCountIntermidiate++;
