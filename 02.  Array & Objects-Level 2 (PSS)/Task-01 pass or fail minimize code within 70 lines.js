// minimaizing within 70 lines of cade try useing switch case //
        ...
        case 'A':
            for(j=0;j<studentDetailsList[i].marks[j];j++){
                if((studentDetailsList[i].gender=="FEMALE")&&(studentDetailsList[i].marks[j]>=50)||(studentDetailsList[i].gender=="MALE")&&(studentDetailsList[i].marks[j]>=30)){
                    tempPassCount+=1;
                    if(tempPassCount==5){
                        console.log('Class:',studentDetailsList[i].class,'Name:',studentDetailsList[i].name,'get passed in all',tempPassCount,'subjects');
                    }
                }
            ...
            if(dummyFailCount>0){
                console.log('Class:',studentDetailsList[i].class,'Name:',studentDetailsList[i].name,'get failed in number of',dummyFailCount,'subjects');
            }
        break;
        case 'B':
            for(j=0;j<studentDetailsList[i].marks[j];j++){
